...
#Nbody solver with memory limiter radius cutoff and nearest neighbour pruning replaced RK4 with verlet
...
# generate bodies
for _ in range(100):
    start_pos = np.random.uniform(-5,5,2)
    start_vel = np.random.uniform(-0.5,0.5,2)
    mass = 1
